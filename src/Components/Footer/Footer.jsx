    ...
    <div className="footerContainer">
      <footer className="container">
        <ul className="social-container">
          <Popup
            trigger={
              <button type="button" className="social-btn rulelogo">
                <img
          ...
          <Popup
            trigger={
              <button type="button" className="social-btn mtglogo">
                <img
          ...
          <Popup
            trigger={
              <button type="button" className="social-btn fblogo">
                <img
          ...
          <Popup
            trigger={
              <button type="button" className="social-btn ytblogo">
                <img
          ...
          <Popup
            trigger={
              <button type="button" className="social-btn twitterlogo">
                <img
        ...
        <p>
          <br />
          <br />
          Portions of Planeswalker are unofficial Fan Content permitted under
          ...
          Wizards of the Coast, LLC, a subsidiary of Hasbro, Inc. Planeswalker
          is not produced by, endorsed by, supported by, or affiliated with
          ...
          <br />
          <br />
          All other content © 2021 Planeswalker, Made by Wild Code School SCCJ
          N.
        </p>
      </footer>
    </div>
